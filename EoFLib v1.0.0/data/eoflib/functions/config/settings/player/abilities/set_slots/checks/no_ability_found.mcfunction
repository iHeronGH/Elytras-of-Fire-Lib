#> eoflib:config/settings/player/abilities/set_slots/checks/no_ability_found
#
...
execute unless score @s eoflib.set_slot.secondary matches 1 run scoreboard players set @s eoflib.set_slot.check -1
execute unless score @s eoflib.set_slot.tertiary matches 1 run scoreboard players set @s eoflib.set_slot.check -1
...
execute if score @s eoflib.set_slot.primary matches 1 if score @s eoflib.set_slot.secondary matches 1 if score @s eoflib.set_slot.tertiary matches 1 run scoreboard players set @s eoflib.set_slot.check 1
    ...
    # Announce fail
execute if score @s eoflib.set_slot.check matches -1 run tellraw @s [{"text": "[", "color": "gray"}, {"text": "E", "color": "red"}, {"text": "o", "color": "gold"}, {"text": "F", "color": "red"}, {"text": "] ", "color": "gray"}, {"text": "Slots failed to save as one or more abilities is missing from your inventory.", "color": "red"}]
