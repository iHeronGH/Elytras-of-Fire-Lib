...
execute if entity @s[predicate=!eoflib:tribes/dragon] run function eoflib:config/settings/player/abilities/fail/not_a_dragon
		...
		## Globally Disabled
execute if data storage eoflib:config Settings[{allow_abilities: off}] if entity @s[tag=!eoflib.admin] run function eoflib:config/settings/player/abilities/fail/admin_disabled
