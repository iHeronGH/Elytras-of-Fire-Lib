...
execute if entity @s[tag=eoflib.admin, tag=!eoflib.abilities.blacklist.tribe, tag=!eoflib.abilities.blacklist.archetype] run function eoflib:config/settings/admin/allow_abilities/blacklist/add/save_ability with storage eoflib:config eoflib.admin_settings.blacklist_register.eof_data.ability_data
execute if entity @s[tag=eoflib.admin, tag=eoflib.abilities.blacklist.tribe] run function eoflib:config/settings/admin/allow_abilities/blacklist/add/save_tribe with storage eoflib:config eoflib.admin_settings.blacklist_register.eof_data.ability_data
execute if entity @s[tag=eoflib.admin, tag=eoflib.abilities.blacklist.archetype] run function eoflib:config/settings/admin/allow_abilities/blacklist/add/save_archetype with storage eoflib:config eoflib.admin_settings.blacklist_register.eof_data.ability_data
