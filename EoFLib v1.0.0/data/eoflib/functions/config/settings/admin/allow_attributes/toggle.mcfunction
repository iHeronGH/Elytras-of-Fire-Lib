...
execute if entity @s[tag=eoflib.admin] store success score _eoflib.admin_settings.allow_attributes eoflib.admin_settings unless predicate eoflib:settings/allow_attributes
