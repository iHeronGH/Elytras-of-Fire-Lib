...
#region
    # Debug
execute if entity @s run tellraw @s[tag=eoflib.debug] [{"text": "[", "color": "dark_gray"}, {"text": "Debug", "color": "gold"}, {"text": "] - ", "color": "dark_gray"}, {"text": "eoflib:gui/uninstall_settings.mcf", "color": "gold", "hoverEvent": {"action": "show_text", "value": {"text": "data/eoflib/functions/config/gui/uninstall_settings.mcfunction", "color": "aqua"}}}]
execute unless entity @s run tellraw @a[tag=eoflib.debug] [{"text": "[", "color": "dark_gray"}, {"text": "Debug", "color": "gold"}, {"text": "] - ", "color": "dark_gray"}, {"text": "eoflib:gui/uninstall_settings.mcf", "color": "gray", "hoverEvent": {"action": "show_text", "value": {"text": "data/eoflib/functions/config/gui/uninstall_settings.mcfunction", "color": "aqua"}}}]
...
execute unless predicate eoflib:settings/uninstall/scoreboards run tellraw @s [{"text": "[", "color": "gray"}, {"text": "❌", "color": "red", "underlined": true, "hoverEvent": {"action": "show_text", "contents": {"text": "Scoreboard data and objectives will persist\nafter this datapack is uninstalled.", "color": "green"}}, "clickEvent": {"action": "run_command", "value": "/execute unless predicate eoflib:settings/uninstall/scoreboards run function eoflib:config/settings/uninstall/scoreboards/toggle_show_ugui"}}, {"text": "] ", "color": "gray"}, {"text": "Keep Scoreboards", "color": "dark_aqua", "hoverEvent": {"action": "show_text", "contents": {"text": "Keep all scoreboard objectives\nand data intact when this datapack\nis uninstalled.", "color": "gray"}}}]
        ...
        ## Storages
            ### Disable
execute if predicate eoflib:settings/uninstall/storages run tellraw @s [{"text": "[", "color": "gray"}, {"text": "✔", "color": "green", "underlined": true, "hoverEvent": {"action": "show_text", "contents": {"text": "Warning: This will delete all storages from\nthe world when this datapack is removed,\nincluding any options you may have made\nany changes to.\n\nProceed with caution!", "color": "red"}}, "clickEvent": {"action": "run_command", "value": "/execute if predicate eoflib:settings/uninstall/storages run function eoflib:config/settings/uninstall/storages/toggle_show_ugui"}}, {"text": "] ", "color": "gray"}, {"text": "Keep Storages", "color": "dark_aqua", "hoverEvent": {"action": "show_text", "contents": {"text": "Keep all storage data intact when this\ndatapack is uninstalled.", "color": "gray"}}}]
...
execute unless predicate eoflib:settings/uninstall/storages run tellraw @s [{"text": "[", "color": "gray"}, {"text": "❌", "color": "red", "underlined": true, "hoverEvent": {"action": "show_text", "contents": {"text": "Storage data will persist after this\ndatapack is uninstalled.", "color": "green"}}, "clickEvent": {"action": "run_command", "value": "/execute unless predicate eoflib:settings/uninstall/storages run function eoflib:config/settings/uninstall/storages/toggle_show_ugui"}}, {"text": "] ", "color": "gray"}, {"text": "Keep Storages", "color": "dark_aqua", "hoverEvent": {"action": "show_text", "contents": {"text": "Keep all storage data intact when this\ndatapack is uninstalled.", "color": "gray"}}}]
        ...
        ## Bossbars
            ### Disable
execute if predicate eoflib:settings/uninstall/bossbars run tellraw @s [{"text": "[", "color": "gray"}, {"text": "✔", "color": "green", "underlined": true, "hoverEvent": {"action": "show_text", "contents": {"text": "Warning: This will delete all bossbars from\nthe world when this datapack is removed,\nincluding any options you may have made\nany changes to.\n\nProceed with caution!", "color": "red"}}, "clickEvent": {"action": "run_command", "value": "/execute if predicate eoflib:settings/uninstall/bossbars run function eoflib:config/settings/uninstall/bossbars/toggle_show_ugui"}}, {"text": "] ", "color": "gray"}, {"text": "Keep Bossbars", "color": "dark_aqua", "hoverEvent": {"action": "show_text", "contents": {"text": "Keep all bossbars intact when this\ndatapack is uninstalled.", "color": "gray"}}}]
