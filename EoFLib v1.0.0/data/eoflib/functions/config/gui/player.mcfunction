...
#region
    # Debug
execute if entity @s run tellraw @s[tag=eoflib.debug, scores={eoflib.debug_mode=2..}] [{"text": "[", "color": "dark_gray"}, {"text": "Debug", "color": "gold"}, {"text": "] - ", "color": "dark_gray"}, {"text": "eoflib:gui/player.mcf", "color": "gold", "hoverEvent": {"action": "show_text", "value": {"text": "You executed the following function:\n- eoflib:config/gui/player.mcfunction", "color": "aqua"}}}]
execute if entity @s at @s run tellraw @a[tag=eoflib.debug, scores={eoflib.debug_mode=3..}, distance=0.1..] [{"text": "[", "color": "dark_gray"}, {"text": "Debug", "color": "gold"}, {"text": "] - ", "color": "dark_gray"}, {"text": "eoflib:gui/player.mcf", "color": "gold", "hoverEvent": {"action": "show_text", "value": [{"selector": "@s", "color": "aqua"}, {"text": " executed the following function:\n- eoflib:config/gui/player.mcfunction", "color": "aqua"}]}}]
execute unless entity @s run tellraw @a[tag=eoflib.debug, scores={eoflib.debug_mode=2..}] [{"text": "[", "color": "dark_gray"}, {"text": "Debug", "color": "gold"}, {"text": "] - ", "color": "dark_gray"}, {"text": "eoflib:gui/player.mcf", "color": "gray", "hoverEvent": {"action": "show_text", "value": {"text": "Server executed the following function:\n- eoflib:config/gui/player.mcfunction", "color": "aqua"}}}]
...
function eoflib:config/gui/player/ability_handling
        ...
        ## Form Submission
# tellraw @s [{"text": "Submit Form", "color": "aqua", "hoverEvent": {"action": "show_text", "contents": {"text": "Let the developer know about any bugs,\nideas, and other things you'd like to share!", "color": "gray"}}}, {"text": "Bug Report", "hoverEvent": {"action": "show_text", "contents": {"text": "Report a bug to the developers of the\nElytras of Fire datapack.", "color": "gray"}}, "clickEvent": {"action": "run_command", "value": "/trigger eoflib.trigger set 70"}}, "  ", {"text": "Idea Submit", "hoverEvent": {"action": "show_text", "contents": {"text": "Submit your ideas to improve the Elytras\nof Fire datapack.", "color": "gray"}}, "clickEvent": {"action": "run_command", "value": "/trigger eoflib.trigger set 71"}}, "  ", {"text": "Other Feedback", "hoverEvent": {"action": "show_text", "contents": {"text": "Let the developers know about any feedback,\nquestions, comments, or concerns you have\nregarding the Elytras of Fire datapack.", "color": "gray"}}, "clickEvent": {"action": "run_command", "value": "/trigger eoflib.trigger set 72"}}]
