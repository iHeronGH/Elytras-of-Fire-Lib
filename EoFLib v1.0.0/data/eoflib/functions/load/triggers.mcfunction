...
execute if score @s eoflib.trigger matches 25 run function eoflib:config/settings/admin/allow_abilities/blacklist/prepare_remove
execute if score @s eoflib.trigger matches 26 run function eoflib:config/settings/admin/allow_abilities/blacklist/remove_earliest_ability
execute if score @s eoflib.trigger matches 27 run function eoflib:config/settings/admin/allow_abilities/blacklist/remove_latest_ability
execute if score @s eoflib.trigger matches 28 run function eoflib:config/settings/admin/allow_abilities/blacklist/remove_all_abilities
execute if score @s eoflib.trigger matches 29 run function eoflib:config/settings/admin/allow_abilities/blacklist/cancel_operation

                #### AS: Allow Attributes
execute if score @s eoflib.trigger matches 30 run function eoflib:config/settings/admin/allow_attributes/toggle_show_pgui
execute if score @s eoflib.trigger matches 31 run function eoflib:config/settings/admin/allow_attributes/toggle_show_agui

                #### AS: Allow Range Display
execute if score @s eoflib.trigger matches 32 run function eoflib:config/settings/admin/allow_range_display/toggle_show_pgui
execute if score @s eoflib.trigger matches 33 run function eoflib:config/settings/admin/allow_range_display/toggle_show_agui
...
execute if score @s eoflib.trigger matches 36 run function eoflib:config/settings/admin/deactivation_timer/toggle_show_agui

                #### AS: Destructive Abilities
execute if score @s eoflib.trigger matches 37 run function eoflib:config/settings/admin/destructive_abilities/toggle_show_agui

                #### AS: Custom Deaths
execute if score @s eoflib.trigger matches 38 run function eoflib:config/settings/admin/custom_deaths/toggle_show_agui

                #### AS: Friendly Fire
execute if score @s eoflib.trigger matches 39 run function eoflib:config/settings/admin/friendly_fire/toggle_show_agui

                #### AS: Cooldown Bypass
execute if score @s eoflib.trigger matches 40 run function eoflib:config/settings/admin/cooldown_bypass/disable_show_agui
execute if score @s eoflib.trigger matches 41 run function eoflib:config/settings/admin/cooldown_bypass/enable_show_agui

                #### AS: Debug Mode
execute if score @s eoflib.trigger matches 42 run function eoflib:config/settings/admin/debug_mode/disable_show_agui
execute if score @s eoflib.trigger matches 43 run function eoflib:config/settings/admin/debug_mode/enable_show_agui
execute if score @s eoflib.trigger matches 44 run function eoflib:config/settings/admin/debug_mode/dec_level_show_agui
execute if score @s eoflib.trigger matches 45 run function eoflib:config/settings/admin/debug_mode/inc_level_show_agui

            ### Uninstall Settings triggers
execute if score @s eoflib.trigger matches 60 run function eoflib:config/settings/uninstall/teams/toggle_show_ugui
execute if score @s eoflib.trigger matches 61 run function eoflib:config/settings/uninstall/scoreboards/toggle_show_ugui
execute if score @s eoflib.trigger matches 62 run function eoflib:config/settings/uninstall/storages/toggle_show_ugui
execute if score @s eoflib.trigger matches 63 run function eoflib:config/settings/uninstall/bossbars/toggle_show_ugui
execute if score @s eoflib.trigger matches 64 run function eoflib:config/settings/uninstall/forceloads/toggle_show_ugui
execute if score @s eoflib.trigger matches 65 run function eoflib:config/settings/uninstall/uninstall_mode/disable_show_ugui
execute if score @s eoflib.trigger matches 66 run function eoflib:config/settings/uninstall/uninstall_mode/enable_show_ugui
execute if score @s eoflib.trigger matches 67 run function eoflib:uninstall/main
execute if score @s eoflib.trigger matches 68 run function eoflib:config/settings/uninstall/uninstall_mode/cancel_uninstall

        ## Form Submissions
execute if score @s eoflib.trigger matches 80 run function eoflib:load/report/bug
execute if score @s eoflib.trigger matches 81 run function eoflib:load/report/idea
execute if score @s eoflib.trigger matches 82 run function eoflib:load/report/feedback
execute if score @s eoflib.trigger matches 83 run function eoflib:load/report/bye_ricardo

        ## Failsafe
execute unless score @s eoflib.trigger matches 0 unless score @s eoflib.trigger matches 2..9 unless score @s eoflib.trigger matches 20..45 unless score @s eoflib.trigger matches 60..68 unless score @s eoflib.trigger matches 80..83 run tellraw @s [{"text": "[", "color": "gray"}, {"text": "E", "color": "red"}, {"text": "o", "color": "gold"}, {"text": "F", "color": "red"}, {"text": "]", "color": "gray"}, {"text": " Invalid range for trigger ", "color": "red"}, {"text": "eoflib.trigger", "color": "gold"}, {"text": "; received value (", "color": "red"}, {"score": {"name": "@s", "objective": "eoflib.trigger"}, "color": "gold"}, {"text": ") does not match expected value range (", "color": "red"}, {"text": "2-9, 20-45, 60-68, 80-83", "color": "gold"}, {"text": ").", "color": "red"}]
