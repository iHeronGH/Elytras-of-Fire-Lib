...
execute anchored eyes positioned ^ ^ ^ if entity @e[sort=nearest, limit=1, type=item, nbt={Item: {components: {"minecraft:custom_data": {"eof_data": {}}}}}, distance=..0.4] run function eoflib:loop/20t/kill_items
