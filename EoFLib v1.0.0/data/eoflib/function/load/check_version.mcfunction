...
execute if score #eoflib.valid_game_ver eoflib.game_ver matches 1 run tellraw @a[tag=eoflib.admin] [{"text": "[", "color": "gray"}, {"text": "E", "color": "red"}, {"text": "o", "color": "gold"}, {"text": "F", "color": "red"}, {"text": "] ", "color": "gray"}, {"text": "Current server data version supported; continuing datapack load.", "color": "gray"}]
        ...
        ## Unsupported version
execute if score #eoflib.valid_game_ver eoflib.game_ver matches 0 run tellraw @a[tag=eoflib.admin] [{"text": "\n[", "color": "gray"}, {"text": "E", "color": "red"}, {"text": "o", "color": "gold"}, {"text": "F", "color": "red"}, {"text": "] ", "color": "gray"}, {"text": "The current server data version (", "color": "red"}, {"score": {"name": "#eoflib.game_ver", "objective": "eoflib.game_ver"}, "color": "gold"}, {"text": ") does not support some features of this update of Elytras of Fire. Please backup and update your server to any version supported by this update (", "color": "red"}, {"score": {"name": "#eoflib.1_20_5", "objective": "eoflib.game_ver"}, "color": "gold", "underlined": true, "hoverEvent": {"action": "show_text", "contents": {"text": "1.20.5", "color": "gray"}}, "clickEvent": {"action": "open_url", "value": "https://minecraft.wiki/w/Java_Edition_1.20.5"}}, {"text": "-", "color": "red"}, {"score": {"name": "#eoflib.1_21_4", "objective": "eoflib.game_ver"}, "color": "gold", "underlined": true, "hoverEvent": {"action": "show_text", "contents": {"text": "1.21.4", "color": "gray"}}, "clickEvent": {"action": "open_url", "value": "https://minecraft.wiki/w/Java_Edition_1.21.4"}}, {"text": "), or ", "color": "red"}, {"text": "update Elytras of Fire Lib", "color": "gold", "underlined": true, "clickEvent": {"action": "open_url", "value": "https://github.com/iHeronGH/Elytras-of-Fire-Lib"}, "hoverEvent": {"action": "show_text", "value": {"text": "Visit Elytras of Fire Lib on Github", "color": "gray"}}}, {"text": ".\n\nTo prevent compatibility issues, Elytras of Fire Lib and all dependencies will now be automatically uninstalled.", "color": "red"}]
